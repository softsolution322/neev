...
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.html">Head Wise Summary Report(Previous Year Collection)</a> <i class="fa fa-angle-right"></i></li>
</ol>
<style>
		   ...
		   if(collectiontype!='')
		   {
			   ...
			   if(collected_by!='')
				...
				if(strt_date!='' && end_date!='')
					...
					$('#edm').css('color','black');
			        $.ajax({
					url:"<?php echo base_url('Report/pre_headwise_data'); ?>",
				    type: "POST",
