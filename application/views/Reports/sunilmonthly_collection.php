...
<ol class="breadcrumb">
	<li class="breadcrumb-item"><a href="#">
			<h4><b>Sunil Enterprises Monthly Collection Report</b></h4>
		</a> <i class=""></i></li>
	...
	<form id='form'>
		...
		<div class='row'>
			<div class="col-md-3 form-group">
				...
				<input type="radio" name="viewtype" id="month_wise" value="2" onclick="dt(this.value)"><b> Select Date Range</b>
			</div>
			<div class="col-md-6 form-group">
		...
		<center>
			<div>
				<button class="btn btn-danger my-button">DISPLAY &nbsp;&nbsp;</button> &nbsp;&nbsp;
				<!-- <a class="btn btn-danger back-button" id="" href="<?php //echo base_url('Report/typeofreports'); 
																		?>">BACK</a> -->
			</div>
		</center>
	</form>
...
<form style="display:none;" id='dmreport' action='<?php echo base_url('Report/sunilmonthly_report'); ?>' method='post'>
					...
					if ($('#date_wise').is(':checked') || $('#month_wise').is(':checked')) {
						...
						if ($('#month_wise').is(':checked')) {
							if (multiple_date1 != '' && multiple_date2 != '') {
								...
								$('#edm').css('color', 'black');
								$.ajax({
									url: "<?php echo base_url('Report/sunilmult_date'); ?>",
									type: "POST",
									data: {
										collectiontype: collectiontype,
										feecollectiontype: feecollectiontype,
