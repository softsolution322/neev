...
?>
<!-- <ol class="breadcrumb">
	<li class="breadcrumb-item"><a href="index.html"><h4><b>Monthly Collection Report</b></h4></a> <i class=""></i></li>
</ol> -->
<style>
	.ui-datepicker-month,
	.ui-datepicker-year {
...
<ol class="breadcrumb">
	<li class="breadcrumb-item"><a href="#">
			<h4><b>Monthly Collection Report</b></h4>
		</a> <i class=""></i></li>
...
<div style="padding: 10px; background-color: white;  border-top:3px solid #5785c3;">
	<form id='form'>
		...
		<center>
			<div>
				<button class="btn btn-success my-button">DISPLAY &nbsp;&nbsp;</button> &nbsp;&nbsp;

				<!-- <a class="btn btn-danger my-button" id="" href="<?php //echo base_url('Report/typeofreports'); 
																		?>">BACK</a> -->
