...
<head>
    <title>All Class Defaulter List</title>
    <style>
        #img {
            float: left;
            height: 100px;
...
<body>
    ...
    <table width="100%" style="float:right;">
        <tr>
            <td style="text-align:center"id="tp-header">
                <?php echo $School_setting[0]->School_Name; ?>
            </td>
        </tr>
        <tr>
            <td style="text-align:center"id="mid-header">
                <?php echo $School_setting[0]->School_Address; ?>
            </td>
        </tr>
        <tr>
            <th style="text-align:center;background-color:;color: !important;">&nbsp;Defaulter  List &nbsp;&nbsp;Upto &nbsp;<?php echo $viewupto; ?></th>
    </tr>
                ...
                <table border="1"  id='example' style="width: 70%;margin: auto;" cellpadding='0' cellspacing='0'>
                        ...
                        ?>
                                 <tr>
                                    ...
                                    <?php
                                        ...
                                        ?></td>
                                    <td style='font-size: 12px;'><?php echo $class_sec; ?></td>
                    ...
                    <tfoot style="background-color:#337ab7">
                        <tr>
                            ...
                            <td align='right'><b style="font-size:16px;color:dark;font-weight: 900;"><?php echo $grand_tot; ?></b></td>
                            <td></td>
                        </tr>
                    </tfoot>
