...
<table width="100%" style="float:right;">
	...
	<tr>
		<td id="tp-header"><center><?php echo $school_setting[0]->School_Address; ?></center></td>
	</tr>
	<tr>
		<td id="tp-header"><center>SESSION (<?php echo $school_setting[0]->School_Session; ?>)</center></td>
	</tr>
	<tr>
		<td id="tp-header"><center>Headwise Summary Report from <?php echo date("d-m-Y", strtotime($single)); ?> To <?php echo date("d-m-Y", strtotime($double)); ?></center></td>
	</tr>
