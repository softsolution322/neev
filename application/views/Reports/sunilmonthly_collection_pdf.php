...
<!-- <p style='float:right; font-size:12px;'>Report Generation Date:<?php //echo date('d-M-Y'); ?></p><br /> -->
	<center><h1 style='font-size:30px;'><?php echo $School_Name; ?></h1>
			<p style='font-size:22px; position:relative; top:-0px;'><?php echo $School_Address; ?>&nbsp;(<?php echo $School_Session; ?>)</p>
			<!--<p style='font-size:22px; position:relative; top:-25px;'>Session&nbsp;(<?php //echo $School_Session; ?>)</p>-->
			<p style='font-size:22px;'>Collection Report from <?php echo date('d-M-Y',strtotime($fromdate)); ?> To <?php echo date('d-M-Y',strtotime($todate)); ?></p>
...
<p style='font-size:20px!important;'><u>Collection Statement Summary</u></p>
...
<hr>
<caption style='font-size:18px!important;' >Amount Collection By Card/Cash/Cheque/Online</caption><br>
