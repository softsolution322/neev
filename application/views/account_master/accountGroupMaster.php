                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label>Group No.</label><span class="req">*</span>
                      <input type="number" name="group_no" class="form-control" value="<?php echo set_value('group_no'); ?>" id="group_no" autocomplete="off" required="" min="1">
                    </div>   
                    <div class="form-group">
