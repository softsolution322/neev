...
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="#">Account Master</a> <i class="fa fa-angle-right"></i> Voucher Entry (General) </li>
</ol>
            ...
            <div class="col-sm-12">
                <div class="box box-primary">
                  <div class="box-header with-border">
                    <p class="box-title" style="font-weight: bold;">Voucher Entry (General)
                      </p><hr>
                  </div>
                  <!-- /.box-header -->
                <form id="addForm">
