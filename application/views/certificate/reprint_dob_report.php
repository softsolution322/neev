...
<body>
	<div class="container-fluid">
	 <div id="border">
		...
		<table class="table">
			...
			<tr>
				<td class="f-s"><p><center><b><i>S/O/D/O</i> &nbsp; <u><?php echo $details_fetch[0]->F_NAME; ?></u></b>&nbsp;<b> & </b>&nbsp; <u><b><?php echo $details_fetch[0]->M_Name; ?></b></u></center></p></td>
			</tr>
			<tr>
				<td class="f-s"><p><center><b><i>Admission No.:</i> &nbsp; <u><?php echo $details_fetch[0]->ADM_NO; ?></u></b>&nbsp;<b>, Class </b>&nbsp; <u><b><?php echo $details_fetch[0]->class_name; ?></b></u>&nbsp;<b><i>is </i></b>&nbsp;&nbsp;<u><b><?php echo $Birth_Date1; ?></b></u></center></p></td>
			</tr>
			<tr>
				<td class="f-s"><p><center><b><i>as per our School Admission Register.</i></b></center></p></td>
			</tr>
			<!--<tr>
	...
	<script type="text/javascript">
		function printl()
		{
			...
			$.ajax({
				url: "<?php echo base_url('Date_of_birth_certificate/reprint_report_status'); ?>",
				type: "POST",
				data: {adm_no:adm_no},
