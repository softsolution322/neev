	 ...
	 <div id="border">
		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-6 col-lg-6">
				...
				<div id="content"><center><b>ALL FEE PAID CERTIFICATE</b></center></div>
			</div>
		...
		<table class="table">
			<tr>
				<td class="f-s"><center><i>This is to certify that <b><?php echo $F_NAME; ?></b> & <b><?php echo $M_Name; ?></b> have paid School Fee for the study of their ward in our
School as per details given below.</i></center></td>
		...
		<table width="100%" border="1">
						<tr>
							...
							<td class="st" rowspan="2">Total Fee Paid</td>
						</tr>
						<tr>
							<td class="st">From</td>
							<td class="st">To</td>
					...
					<table width="100%" border='1'>
							...
							if($feehead){
								foreach($feehead as $key => $value){
									...
									if($daycoll[0]->$fee > 0){
										?>
										<tr>
											<td class="st"><?php echo $value->FEE_HEAD; ?></td>
											<td class="st"><?php echo $fee_details[$key]; ?></td>
											<td class="st"><?php echo $daycoll[0]->$fee; ?></td>
										</tr>
										<?php
									}
								}
						...
						?>
						<tr>
							<td colspan="2" class="st"><b>GRAND TOTAL</b></td>
							<td class="st"><?php echo $daycoll[0]->TOTAL; ?></td>
						</tr>
					</table>
					<div class="row">
	 ...
	 <div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12">
			<center><button class="btn btn-primary" id="printing_button" onclick="printl()"><i class="fa fa-print"></i>&nbsp;PRINT</button>&nbsp;<a class="btn btn-danger" id="print_cancel" href="<?php echo base_url('Fee_paid_all_certificate/show_tution'); ?>">BACK</a></center>
		</div>
	 </div><br /><br />
	</div>
