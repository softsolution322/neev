<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.html">Bonafide Certificate</a> <i class="fa fa-angle-right"></i></li>
</ol>
<div style="padding: 10px; background-color: white;  border-top:3px solid #5785c3;">
	<form id="form">
		<div class="row">
			...
			<div class="col-md-4 col-sm-4 col-lg-4 form-group">
				<label>Bonafide Certificate No.</label>
...
<script>
    ...
    $.ajax({
		url: "<?php echo base_url('Bonafide_certificate/bonafide_fetch_details'); ?>",
		type: "POST",
		data: $("#form").serialize(),
		success: function(data){
			...
			if(data_cnt == 1){
				...
				if(chk_details == 1){
					var adm_no = user[2];
					if( confirm("Bonafide Certificate Alredy Generated Want To Re-Print") ){
						window.location="<?php echo base_url('Bonafide_certificate/re_print_bona/'); ?>"+adm_no;
					}
				}
				else{
					$.ajax({
						url: "<?php echo base_url('Bonafide_certificate/re_bona_data'); ?>",
						type: "POST",
						data : $("#form").serialize(),
						success:function(data){
							$("#load_data").html(data);
