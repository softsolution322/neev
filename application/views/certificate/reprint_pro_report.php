  ...
  <head>
   ...
   <body>
			...
			<div class="col-md-2 col-sm-2 col-lg-2">
				  ...
				  <center><h6><b><div id="content">PROVISIONAL SCHOOL LIVING CERTIFICATE</div></b></h6></center>
	  ...
	  <div style="border:3px solid #000; padding:10px;">
			...
			<div class="col-md-2 col-sm-2 col-lg-2">
				  ...
				  <center><h6><b><div id="content1">PROVISIONAL SCHOOL LIVING CERTIFICATE</div></b></h6></center>
		   <p style="font-style: italic;">Certificate No. : <?php echo $details_fetch[0]->CERT_NO; ?></p>
