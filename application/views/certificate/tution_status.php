<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.html">Tution Fee Certificate</a> <i class="fa fa-angle-right"></i></li>
</ol>
...
<script>
    ...
    $.ajax({
		url: "<?php echo base_url('Tution_fee_certificate/birth_fetch_details'); ?>",
		type: "POST",
		data: $("#form").serialize(),
		success: function(data){
			...
			if(data_cnt == 1){
				$.ajax({
					url: "<?php echo base_url('Tution_fee_certificate/re_dob_data'); ?>",
					type: "POST",
					data : $("#form").serialize(),
					success:function(data){
						$("#load_data").html(data);
