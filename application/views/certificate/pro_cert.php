<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.html">Provisional Certificate</a> <i class="fa fa-angle-right"></i></li>
</ol>
<div style="padding: 10px; background-color: white;  border-top:3px solid #5785c3;">
	<form id="form">
		<div class="row">
			...
			<div class="col-md-4 col-sm-4 col-lg-4 form-group">
				<label>Provisional Certificate No.</label>
...
<script>
    ...
    $.ajax({
		url: "<?php echo base_url('Provisional_certificate/pro_fetch_details'); ?>",
		type: "POST",
		data: $("#form").serialize(),
			...
			if(data_cnt == 1){
				...
				if(chk_details == 1){
					...
					if( confirm("Provisional Certificate Already Generated Want To Re-Print") ){
						window.location="<?php echo base_url('Provisional_certificate/re_print_pro/'); ?>"+adm_no;
					}
				}
				else{
					$.ajax({
						url: "<?php echo base_url('Provisional_certificate/re_pro_data'); ?>",
						type: "POST",
						data : $("#form").serialize(),
						success:function(data){
							$("#load_data").html(data);
