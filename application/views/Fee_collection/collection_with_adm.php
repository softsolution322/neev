  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-sm">
      ...
      <div class="modal-content">
    	...
    	<div class="row">
	    		<div class="col-md-12">
	    			<center><input type="submit" onclick="modal_validation()" name="submit" value="MAKE PAYMENT" class="btn btn-success">&nbsp;&nbsp;&nbsp;<!-- <input type="reset" name="reset" value="reset" class="btn btn-success"> --><a class="btn btn-danger " id="" href="<?php echo base_url('Fees_collection/school_collection'); ?>">BACK</a></center>
	    		</div>
	    	</div>	
	</div><br />
