...
<body onload="printl_body()">
	...
	<div style="position: relative; margin-top: 50%; margin-left: 45%;">
		<button class="btn btn-primary" id="printing_button" onclick="printl()">PRINT</button>
		&nbsp;
		<a class="btn btn-danger" id="back_button" href="<?php echo base_url('Monthly_collection/month_collection') ?>">BACK</a>
	</div>
