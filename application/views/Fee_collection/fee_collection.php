<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.html">School Collection</a> <i class="fa fa-angle-right"></i></li>
</ol>
<style type="text/css">
  body{
		...
		<div class="four-grids">
					...
					<div class="col-md-3 four-grid">
						...
						<div class="four-wthree">
							...
							<div class="four-text">
								<h3>Article Sold <br/><br/></h3>
							</div>
							
						</div></a>
						<br><br>
						<center>
						<a class="btn btn-danger " id="" href="<?php echo base_url('Student_report/show_studentpanel3'); ?>">BACK</a></center>
					</div>
