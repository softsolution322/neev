 <?php
	if ($master) {
		...
		$recptNumeric = $this->db->query("SELECT MAX(CAST(SUBSTR(TRIM(RECT_NO),2) AS UNSIGNED)+1) MAX_NUMBER FROM daycoll WHERE RECT_NO RLIKE '$CounterNo'")->result();
 ...
 <ol class="breadcrumb">
 	<li class="breadcrumb-item"><a href="#">
 			<h4><b>Miscellaneous Collection</b></h4>
 		</a> <i class=""></i></li>
 	...
 	<form onsubmit="return validation()" action="<?php echo base_url('Fees_collection/misc_collection_data'); ?>" method="post">
 		<div class="row">
 			<div class="col-md-12 col-xs-12">
 				<div class="row">
 					...
 					<div class="col-md-3 col-xs-3 form-group">
 						...
 						<input list="browsers" onchange="adm_function(this.value)" name="adm_no" class="form-control">
 				...
 				<div class="row">
 					...
 					<div class="row">
 						<div class="col-sm-12 col-md-12">
 							...
 							<!-- <a class="btn btn-danger pull-right" id="" href="<?php echo base_url('Fees_collection/school_collection'); ?>">BACK</a></center> -->
 							<!-- <a class="btn btn-danger pull-right" id="" href="<?php echo base_url('payroll/dashboard/emp_dashboard'); ?>">BACK</a></center></br> -->
 						</div>
 					</div>
 				</div>
 			</div>
 			...
 			<div class="row" id="showbutton" style="display: none;">
 				<div class="col-sm-12 col-md-12">
 					<center>
 						<p id="show_ledger_info" class="btn btn-success" onclick="show_ledger()">Show Ledger</p>&nbsp;<input type="reset" onclick="rst()" class="btn btn-success" name="reset" value="reset">
 					</center>
 				</div>
 			</div>
 		</div>
