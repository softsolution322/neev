...
<body>
					...
					<td colspan="3">
						<table width="100%" class="table1">
							<tr class="tr1">
								...
								<td class="td1"><?php echo date('Y-m-d', strtotime($RECT_DATE)); ?></td>
							</tr>
							<tr class="tr1">
	...
	<div style="position: relative; margin-top: 50%; margin-left: 45%;">
		<button class="btn btn-primary" id="printing_button" onclick="printl()">Print</button>&nbsp;<a class="btn btn-danger" id="print_cancel" href="<?php echo base_url('Fees_collection/misc_collection/') ?>">BACK</a>
	</div>
	<br>
	<br>
	<br>
