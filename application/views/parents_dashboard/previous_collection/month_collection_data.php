...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Fee Summary</a></li>
        <li class="active">Online Payment</li>
		<li class="active">Previous Dues</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-primary" data-select2-id="15">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-table"></i> Previous Year Dues</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body" >
        	<div class="row">
...
<form id='student_details'>
	<div class="row">
		...
		<div class="col-md-4 col-sm-4 col-xl-4 form-group">
		...
		<div class="col-md-4 col-xl-4 col-sm-4 form-group">
	...
	<div class="modal-dialog">
	  ...
	  <div class="modal-content">
		<div class="modal-header" style="background: #5785c3; color: #fff; font-weight: bold;">
		  ...
		  <h4 class="modal-title"><CENTER>Unpaid Month</CENTER></h4>
		</div>
		<div class="modal-body">
				...
				<?php
					...
					foreach($pre_month as  $key=>$value){
						...
						<div class="col-sm-2 col-md-2 form-group">
							<input type="checkbox" onchange="monthckechk()" class="<?php echo $i; ?>" name="month[]" value="<?php echo $value->Month_NM; ?>" id="<?php echo strtolower($value->Month_NM); ?>">&nbsp;<?php echo $value->Month_NM; ?>
						</div>
						<?php
						$i++;
					}
			...
			<div class="row">
				<div class="col-md-12 col-sm-12">
					<center><button class="btn btn-primary">Get Details</button></center>
				</div>
			</div>
		</div>
...
function show_pay(){
	...
	if($('#apr').is(':checked') || $('#may').is(':checked') || $('#jun').is(':checked') || $('#jul').is(':checked') || $('#aug').is(':checked') || $('#sep').is(':checked') || $('#oct').is(':checked') || $('#nov').is(':checked') || $('#dec').is(':checked') || $('#jan').is(':checked') || $('#feb').is(':checked') || $('#mar').is(':checked'))
	{
		...
		$.ajax({
			url: "<?php echo base_url('Onparent_details/get_pay_details'); ?>",
			type: "POST",
