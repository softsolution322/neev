             ...
             <!--header start here-->
				<div class="header-main">
					<div class="logo-w3-agile">
					    <h1><a href="index.html">MICA</a></h1>
					</div>
					<div class="w3layouts-left" style="background:#fff!important">
					  <div class="clearfix"> </div>
					</div>
					<div class="w3layouts-right" style="background:#fff!important">
					  <div class="clearfix"> </div>				
					</div>
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img src="<?php echo base_url(); ?>assets/dash_images/in4.jpg" alt=""> </span> 
												<div class="user-name">
													<p>Malorum</p>
...
<p>© All Rights Reserved | Design by  <a href="#" target="_blank">MICA EDUCATIONAL COMP (P) LTD</a> </p>
</div>	
