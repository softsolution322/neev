...
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.html">Class Wise Ledger</a> <i class="fa fa-angle-right"></i></li>
</ol>
		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-3 col-lg-3 col-xl-3 form-group">
				...
				<select class="form-control" required name="fee_type">
					...
					<option value="month_fee">Month Fee</option>
...
<script>
	...
	event.preventDefault();
		$.ajax({
			url: "<?php echo base_url('Class_report/find_details'); ?>",
			type: "POST",
			data: $('#form').serialize(),
			beforeSend:function(){
				$('.loader').show();
