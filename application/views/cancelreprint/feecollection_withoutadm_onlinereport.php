...
<body onload="printl_body()">
	<div id="body">
		<div id="box1">
			...
			<div class="table_heading">
				...
				<span class="webemail">Website: <?php echo $school_web; ?></span><!-- <span class="webemail"> Email: <?php //echo $school_email; 
																														?></span> --><br>
					...
					<td colspan="3">
						<table width="100%" class="table1">
							...
							<tr class="tr1">
								...
								<td class="td1"><?php echo $CLASS; ?></td>
								<td class="td1">Payment Mode:</td>
								<td class="td1"><?php echo $Payment_Mode; ?></td>
							</tr>
							<tr class="tr1">
								<td class="td1">Fee For:</td>
								<td class="td1"><?php echo $PERIOD; ?></td>
								<td class="td1">Form No:</td>
								<td class="td1"><?php echo $FORM_NO; ?></td>
							</tr>
						</table>
					</td>
				</tr>
		...
		<div id="box2">
			...
			<div class="table_heading">
				...
				<span class="webemail">Website: <?php echo $school_web; ?></span><!-- <span class="webemail"> Email: <?php //echo $school_email; 
																														?></span> --><br>
				<span class="feecopy">FEE-RECEIPT(PARENT'S COPY)</span>
			</div>
			<table class="table_data" width="100%" border="1" class="table_main">
				<tr>
					<td colspan="3">
						<table width="100%" class="table1">
							<tr class="tr1">
	...
	<br>
	<br>
	<div style="position: relative; margin-top: 50%; margin-left: 45%;">
		<button class="btn btn-primary" id="printing_button" onclick="printl()">Print</button>&nbsp;<a class="btn btn-danger" id="back_button" href="<?php echo base_url('Cancel_reprint/cancel_reprintt/') ?>">BACK</a>
	</div>
	<br>
	<br>
	<br>
