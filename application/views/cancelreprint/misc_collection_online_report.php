...
<body>
	...
	<div style="position: relative; margin-top: 50%; margin-left: 45%;">
		<button class="btn btn-primary" id="printing_button" onclick="printl()">Print</button>&nbsp;<a class="btn btn-danger" id="print_cancel" href="<?php echo base_url('Cancel_reprint/cancel_reprintt/') ?>">BACK</a>
	</div>
	<br>
	<br>
	<br>
