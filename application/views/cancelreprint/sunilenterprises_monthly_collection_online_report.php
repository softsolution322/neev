        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-lg-6">
                <table width="100%" border="1" cellpadding="0" cellspacing="0">
                    <tr>
                        <td colspan="4">
                            <table width="100%">
                                <tr>
                                    <th>
                                        <center><b style="font-size: 29px !important;">Sunil Enterprises</b></center>
                                    </th>
                                </tr>
                                <tr>
                                    <td>
                                        <center><b style="font-size: 9px;">
                                                <hr class="hr1">
                                                Near Bharti Hospital, Below Over Bridge, New Anantpur, Ranchi
                                            </b></center>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <center><b style="font-size: 10px;">Ph.: +919631088704
                                            </b></center>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td colspan="4">
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td colspan="1">: <?php echo $school_name; ?></td>
                                </tr>
                                <tr>
                                    <td><b>Roll No.</b></td>
                                ...
                                <tr>
                                    <td colspan="1"><b>Name of Purchaser</b></td>
                                    <td colspan="1">: <?php echo $STU_NAME; ?></td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td width="14%"><b style="font-size:9px;">In Words</b></td>
                    ...
                    <tr>
                        <td colspan="4">
                            <table width="100%">
                                <tr>
                                    <td colspan="6">
                                        <center><B>PARENT'S COPY</B></center>
                                    </td>
                                </tr>
                                <tr>
                                    <td><b>Receipt No.</b></td>
