...
<form id='student_details'>
	<div class="row">
		...
		<div class="col-xs-3 col-md-3 col-lg-3 form-group">
			...
			<input type="text" class="form-control" name="date1" id="date1" value="<?php echo date("d-M-Y"); ?>" required>
		</div>
		<div class="col-md-3 col-sm-3 col-xl-3 form-group">
		...
		<div class="col-xs-9 col-md-9 col-lg-9 form-group">
			<label>Fee For</label>
			<input type="text" class="form-control" value="ARTICLE SOLD-ARTICLES_SALE" readonly name="fee_for">
		</div>
		<div class="col-sm-3 col-md-3 col-xl-3 form-group">
			<br />
			<span class="btn btn-success" onclick="show_ledger()"><i class="fa fa-circle-o-notch fa-spin" style="display: none;" id="show_details_l"></i>&nbsp;Show paid amount</span>
	...
	<div class="row">
		<div class="col-sm-12 col-md-12 col-xl-12">
			<center>
				<button type="submit" class="btn btn-success" onclick='get_payment_details()' id="get_details_pay"><i class="fa fa-circle-o-notch fa-spin" style="display: none;" id="get_details_p"></i>&nbsp;Get Details</button>
			</center>
		</div>
	</div><br />
</form>
