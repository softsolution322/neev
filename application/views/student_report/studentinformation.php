...
<ol class="breadcrumb">
	<li class="breadcrumb-item"><a href="#">
			<h4><b>Class Wise Student Information</b></h4>
		</a> <i class=""></i></li>
	...
	<form id="form" method="post">
		<div class="row">
			...
			<!-- <div class="col-md-4 col-sm-4 col-lg-4 col-xl-4 form-group">
				<label hidden>Select Sec</label>
				<select class="form-control" required name="sec_name" id="sec" hiddenn>
...
<script>
	...
	event.preventDefault();
		$.ajax({
			url: "<?php echo base_url('Student_report/find_detailsstudentinformation'); ?>",
			type: "POST",
			data: $('#form').serialize(),
			beforeSend:function(){
				$('.loader').show();
