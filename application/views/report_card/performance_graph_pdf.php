	    ...
	    <div class='col-sm-12'>
		  <table class='table'>
			...
			<tr>
			  ...
			  <td><h3><center>Subject wise average marks</center></h3></td>
...
<script>
  $.ajax({
    url: "<?php echo base_url('report_card/Performance_graph_report/fetch_data'); ?>",
    method: "GET",
    dataType:"json",
