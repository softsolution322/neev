<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="index.html">Student Route Report</a> <i class="fa fa-angle-right"></i></li>
</ol>
	...
	<div class="row">
		<form id="form">
			...
			<div class="col-md-3 col-sm-3 form-group">
				...
				<select class="form-control" onchange="GetStoppage()" required name="prefrence" id="prefrence">
					
				</select>
			</div>
			<div class="col-md-3 col-sm-3 form-group">
				<label>Select Stoppage</label>
				<select class="form-control" onchange="Getfindata()" required name="stoppage" id="stoppage">
...
function load_data(){
	...
	$.ajax({
		url:"<?php echo base_url('TransportReport/Studentroutereport/load_data'); ?>",
		method:"POST",
		data:{vehicleno:vehicleno,trip:trip,prefrence:prefrence,stoppage:stoppage},
...
function Gettrip(){
  ...
  {
    $.ajax({
      url:'<?php echo base_url('TransportReport/Studentroutereport/gettripid'); ?>',
...
function GetPrefrence(){
  ...
  {
    $.ajax({
      url:'<?php echo base_url('TransportReport/Studentroutereport/getpreference'); ?>',
...
function GetStoppage(){
  ...
  {
    $.ajax({
      url:'<?php echo base_url('TransportReport/Studentroutereport/getstoppage'); ?>',
      data:{vehicleno:vehicleno,trip:trip,prefrence:prefrence},
      method:"post",
      dataType:"json",
      success:function(response)
