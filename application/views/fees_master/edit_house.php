...
?>
<ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="#">Edit House</a> <i class="fa fa-angle-right"></i></li>
</ol>
<!--four-grids here-->
        ...
        <div class='col-sm-12'>		
		  ...
		  <form action="<?php echo base_url('Fees_master/house_update'); ?>" method="post" onsubmit="return validation()">
		  <table class="table table-bordered" id="class_table">
			<tr>
			  <td><b>House Name</b></td>
			  <td><input type="text" id="house" name="house" class="form-control" value="<?php echo $HOUSENAME;?>"></td>
			<tr>
			<tr>
