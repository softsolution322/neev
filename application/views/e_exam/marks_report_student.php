...
<?php $t=""; ?>
<ol class="breadcrumb">
  <li class="breadcrumb-item"><a href="#">Objective Marksheet </a> <i class="fa fa-angle-right"></i></li>
</ol>
<!--four-grids here-->
...
<script>
	function classess(class_code){
		...
		$.ajax({
			url: "<?php echo base_url('e_exam/MarksReportstudent/Class_sec'); ?>",
			type: "POST",
	...
	function section_sec(sec_no){
		...
		$.ajax({
			url: "<?php echo base_url('e_exam/MarksReportstudent/subject_nam'); ?>",
			type: "POST",
	...
	function subject_ids(subject_ids){
		...
		$.ajax({
			url: "<?php echo base_url('e_exam/MarksReportstudent/examDate'); ?>",
			type: "POST",
	...
	function btn_submit(){
		...
		//alert(exam_date);
		$.ajax({
			url: "<?php echo base_url('e_exam/MarksReportstudent/generateMarksReport'); ?>",
			type: "POST",
